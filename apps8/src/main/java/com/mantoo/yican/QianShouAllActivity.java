...
public class QianShouAllActivity extends BaseActivity implements View.OnClickListener, ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    private LinearLayout checkBoxL,completion_daishou_L;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qianshou_all);

        completion_checkbox = (CheckBox) findViewById(R.id.completion_checkbox);
        checkBoxL = (LinearLayout) findViewById(R.id.checkBoxL);
        completion_daishou_L = (LinearLayout) findViewById(R.id.completion_daishou_L);
        complete_account = (TextView) findViewById(R.id.complete_account);

        resources = getResources();// 获得res资源对象
        config = resources.getConfiguration();// 获得设置对象
        httpUtil = new HttpUtil();
        findViewById(R.id.qiaoshou_button).setOnClickListener(this);
        findViewById(R.id.click_qianshou).setOnClickListener(this);
        findViewById(R.id.qianshou_all_return).setOnClickListener(this);
        initImagePicker();
        initWidget();
        initView();

        completion_checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            @Override
            public void onCheckedChanged(CompoundButton buttonView,
                                         boolean isChecked) {
                if(isChecked){
                    completion_checkbox.setSelected(true);
                }else{
                    completion_checkbox.setSelected(false);
                }
            }
        });
    }
    ...
    private void initView() {
        ...
        if(totalAccount != null && !totalAccount.equals("") && (Double.parseDouble(totalAccount) > 0))
        {
            complete_account.setText(totalAccount + "元");
            completion_checkbox.setSelected(false);
            checkBoxL.setVisibility(View.VISIBLE);
            completion_daishou_L.setVisibility(View.VISIBLE);
        }
        else
        {
            completion_checkbox.setSelected(true);
    ...
    private void initWidget() {
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.qianshouAll_submit_picAddr);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            case 0: // 直接调起相机
                                ...
                                Intent intent = new Intent(QianShouAllActivity.this, ImageGridActivity.class);
                            ...
                            case 1:
                                //打开选择,本次允许选择的数量
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(QianShouAllActivity.this, ImageGridActivity.class);
...
//                                intent1.putExtra(ImageGridActivity.EXTRAS_IMAGES,images);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.qiaoshou_button:
                if(!completion_checkbox.isSelected())
                {
                            ...
                            public void onSuccess(Object t) {
                                ...
                                try {
                                    ...
                                    if (object.optInt(Constants.RESULT_CODE) == 0) {
                                        ...
                                        Intent intent = new Intent(QianShouAllActivity.this, FaCheActivity.class);
                ...
                break;
            case R.id.click_qianshou:
                Intent intent = new Intent(QianShouAllActivity.this, PenActivity.class);
                intent.putExtra("acitvity", "QianShouAllActivity");
                intent.putExtra("mission_no", missionNo);
                intent.putExtra("waybillNo", waybillNos);
                intent.putExtra("totalAccount",totalAccount);
                startActivity(intent);
                break;
            case R.id.qianshou_all_return:
                if(activity.equals("FaCheActivity"))
                {
                    Intent intent11 = new Intent(QianShouAllActivity.this, FaCheActivity.class);
                    startActivity(intent11);
                    finish();
                }
                else
                {
                    Intent intent11 = new Intent(QianShouAllActivity.this, FaCheInfoActivity.class);
                    intent11.putExtra("type", type);
                    intent11.putExtra("mission_no", missionNo);
                    startActivity(intent11);
                    finish();
                }
