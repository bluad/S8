...
public class MainUrl {
    ...
    public static final String ADDRESS = "http://yican2017.mantoo.com.cn:8081/YiChanPlatform.asmx/GetAddress";
     ...
     public static final String URL = "http://zk205.mantoo.com.cn:8016/S8/mantu/appInterface";
     public static final String BASEURL = "http://zk205.mantoo.com.cn:8016/S8/mantu/appInterface/";

    //public static final String URL = "http://yican56.com:8102/S8/mantu/appInterface";
    //public static final String BASEURL = "http://yican56.com:8102/S8/mantu/appInterface/";

    //public static final String URL = "http://www.yican56.com:8102/S8/mantu/appInterface";
    //public static final String BASEURL = "http://www.yican56.com:8102/S8/mantu/appInterface/";
    ...
    // 34、签名
    public static final String TASKORDERARRIVE = "/TaskOrderArrive";
    // 35、发送
    public static final String REPALY = "/replay";
    // 36、查询消息
    public static final String SEARCHMESSAGE = "/searchMessage";
    // 37、查询消息
    public static final String GETUNREANUMBER = "/getUnreadNumber";
