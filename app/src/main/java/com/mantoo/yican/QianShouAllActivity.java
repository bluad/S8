...
public class QianShouAllActivity extends BaseActivity implements View.OnClickListener, ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    private EditText note_qiaoshou;
    ...
    private void initView() {
        ...
        note_qiaoshou = (EditText) findViewById(R.id.note_qiaoshou);
        ...
        if(picPath != null)
        {
            ...
            uploadImage(MainUrl.URL + MainUrl.UPLOADPICTURES, picPath, missionNo, waybillNos);
            return;
        }
    }
        ...
        switch (v.getId()) {
            case R.id.qiaoshou_button:
                ...
                if(picPath == null || picPath.equals(""))
                {
                    if(config.locale.equals(Locale.SIMPLIFIED_CHINESE))
                    {
                        showStringToastMsg("请填写签收人！");
                    }
                    else
                    {
                        showStringToastMsg("Please input signer！");
                    }
                    return;
                }
                showLoadingDialog();
                MobApi.uploadFiles(images, 0x030, new MyCallBack() {
                    ...
                    public void onSuccess(int what, Object result) {
                        ...
                        params.put("note", note_qiaoshou.getText().toString());
                        String url = MainUrl.URL + MainUrl.UPDATESIGN;
            ...
            case R.id.click_qianshou:
                ...
                intent.putExtra("notes", note_qiaoshou.getText().toString());
                startActivity(intent);
                break;
