...
public class TaskExpressInfoActivity extends BaseActivity implements View.OnClickListener, TaskExpressInfoAdapter.Callback {
    ...
    private List<GoodInfo> showList = new ArrayList<GoodInfo>();

    private List<GoodInfo> paramsList = new ArrayList<GoodInfo>();
    ...
    private void initView() {
        ...
        paramsList =  (ArrayList<GoodInfo>) getIntent().getSerializableExtra("paramsList");
        ...
        switch (v.getId()) {
            case R.id.task_express_info_button:
                ...
                if(!(currentLng == null || currentLng.equals("") || currentLat == null || currentLat.equals("")))
                {
                    ...
                    {
                        showSetDeBugDialog(sb.toString());
                    }
                }
                else
                {
    ...
    //提货提交
    private void submitHuo(String waybillNos, String selectSers){
    ...
    private void showSetDeBugDialog(String waybills) {
        final String mNumber = waybills;
        ...
        {
            //过滤此任务单下面的订单集合
            for(GoodInfo temp : paramsList)
            {
                if(temp.getWaybillNumber().equals(str))
                {
        ...
        GoodInfoAdapter adapter = new GoodInfoAdapter(TaskExpressInfoActivity.this, R.layout.item_listview_good_info, showList);
