...
public class QRCodeEncoder {
    ...
    /**
     * 同步创建黑色前景色�?�白色背景色的二维码图片。该方法是�?�时操作，请在子线程中调用�??
     *
     * @param content 要生成的二维码图片内�?
    ...
    /**
     * 同步创建指定前景色�?�白色背景色的二维码图片。该方法是�?�时操作，请在子线程中调用�??
     *
     * @param content         要生成的二维码图片内�?
     * @param size            图片宽高，单位为px
     * @param foregroundColor 二维码图片的前景�?
     */
    ...
    /**
     * 同步创建指定前景色�?�白色背景色、带logo的二维码图片。该方法是�?�时操作，请在子线程中调用�??
     *
     * @param content         要生成的二维码图片内�?
     * @param size            图片宽高，单位为px
     * @param foregroundColor 二维码图片的前景�?
    ...
    /**
     * 同步创建指定前景色�?�指定背景色、带logo的二维码图片。该方法是�?�时操作，请在子线程中调用�??
     *
     * @param content         要生成的二维码图片内�?
     * @param size            图片宽高，单位为px
     * @param foregroundColor 二维码图片的前景�?
     * @param backgroundColor 二维码图片的背景�?
     * @param logo            二维码图片的logo
     */
