...
public class CaiWuInfoActivity extends BaseActivity implements View.OnClickListener, CompletionInfoAdapter.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caiwu_info);
        initView();
    }

    private void initView() {
        findViewById(R.id.caiwu_express_info_return).setOnClickListener(this);
                ...
                try {
                    ...
                    if (object.optInt(Constants.RESULT_CODE) == 0) {
                        ...
                        if (array.length() > 0) {
                            ...
                            CompletionInfoAdapter adapter = new CompletionInfoAdapter(CaiWuInfoActivity.this, R.layout.item_listview_caiwu_info, dataList, CaiWuInfoActivity.this);
    ...
    public void click(View v) {
        ...
        Intent intent = new Intent(CaiWuInfoActivity.this, BaiduMapActivity.class);
        intent.putExtra("mission_no", missionNo);
        intent.putExtra("activity", "CaiWuInfoActivity");
    ...
    protected void onResume() {
        ...
        completionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(CaiWuInfoActivity.this, WayBillInfoActivity.class);
                intent.putExtra("waybillNo", task.getWaybillNo());
                intent.putExtra("missionNo", missionNo);
                intent.putExtra("activityType", "CaiWuInfoActivity");
                startActivity(intent);
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.caiwu_express_info_return:
                Intent intent = new Intent(CaiWuInfoActivity.this, CaiWuActivity.class);
                startActivity(intent);
                finish();
                break;
        }
