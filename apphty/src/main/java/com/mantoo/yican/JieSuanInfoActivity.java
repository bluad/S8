...
public class JieSuanInfoActivity extends BaseActivity implements View.OnClickListener, CompletionInfoAdapter.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jiesuan_info);
    ...
    private void initView() {
        ...
        findViewById(R.id.jiesuan_express_info_return).setOnClickListener(this);
                ...
                try {
                    ...
                    if (object.optInt(Constants.RESULT_CODE) == 0) {
                        ...
                        if (array.length() > 0) {
                            ...
                            CompletionInfoAdapter adapter = new CompletionInfoAdapter(JieSuanInfoActivity.this, R.layout.item_listview_completion_info, dataList, JieSuanInfoActivity.this);
    ...
    protected void onResume() {
        ...
        completionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(JieSuanInfoActivity.this, WayBillInfoActivity.class);
                intent.putExtra("waybillNo", task.getWaybillNo());
                intent.putExtra("missionNo", missionNo);
                intent.putExtra("activityType", "JieSuanInfoActivity");
    ...
    public void click(View v) {
        ...
        Intent intent = new Intent(JieSuanInfoActivity.this, BaiduMapActivity.class);
        intent.putExtra("activity", "JieSuanInfoActivity");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.jiesuan_express_info_return:
                Intent intent = new Intent(JieSuanInfoActivity.this, JieSuanActivity.class);
                startActivity(intent);
                finish();
                break;
        }
