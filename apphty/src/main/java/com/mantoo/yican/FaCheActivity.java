...
public class FaCheActivity extends BaseActivity implements View.OnClickListener {
                                ...
                                try {
                                        ...
                                        if (object.optInt(Constants.RESULT_CODE) == 0) {
                                                ...
                                                if (array.length() > 0) {
                                                        ...
                                                        FaCheAdapter adapter = new FaCheAdapter(FaCheActivity.this, R.layout.item_listview_fache, dataList);
                ...
                faCheListView.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                                ...
                                switch (index) {
                                        case 0:
                                                // 接单
                                                qianShou(task.getWay(), task.getMissionNo(), task.getTotalAcount());
                                                break;
                                }
                                return false;
                        }
         ...
         * 签收按钮 全部到站签收
         */
        public void qianShou(String way, String missionNo, String totalIAccount) {
                if(way.equals("中转"))
                {
                        // 中转到站
                        AjaxParams params=new AjaxParams();
                        ...
                        params.put("driverid", AppCache.getString(AppCacheKey.driverid));
                        String url = AppCache.getString(AppCacheKey.http_url) + MainUrl.TASKORDERSIGN;
                        PDAApplication.http.configTimeout(8000);
                        showLoadingDialog();
                        PDAApplication.http.post(url,params,new AjaxCallBack<Object>() {
                                public void onSuccess(Object t) {
                ...
                else
                {
                        ...
                        intent.putExtra("totalAccount", totalIAccount);
