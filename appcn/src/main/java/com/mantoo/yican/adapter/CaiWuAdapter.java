...
public class CaiWuAdapter extends ArrayAdapter<ExpressStatus>{

    private int resourceId;

    public CaiWuAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView missionNo = (TextView) view.findViewById(R.id.caiwu_express_missionNo);
        TextView expressDate = (TextView) view.findViewById(R.id.caiwu_express_date);
        TextView expressTime = (TextView) view.findViewById(R.id.caiwu_express_time);
        TextView line = (TextView) view.findViewById(R.id.caiwu_express_line);
        ImageView way = (ImageView) view.findViewById(R.id.caiwu_express_way);
        TextView number = (TextView) view.findViewById(R.id.caiwu_express_number);
        TextView jianShu = (TextView) view.findViewById(R.id.caiwu_express_jianshu);
        TextView tiJi = (TextView) view.findViewById(R.id.caiwu_express_tiji);
        TextView weight = (TextView) view.findViewById(R.id.caiwu_express_weight);
        TextView pay = (TextView) view.findViewById(R.id.caiwu_express_pay);
